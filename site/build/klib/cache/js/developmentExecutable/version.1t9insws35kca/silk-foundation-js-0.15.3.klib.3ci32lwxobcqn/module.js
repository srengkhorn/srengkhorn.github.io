(function (root, factory) {
  ...
  var Style$composable = kotlin_org_jetbrains_compose_html_html_core.$_$.y5;
  ...
  var titleCamelCaseToKebabCase = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.z2;
  ...
  var Companion_getInstance_0 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.j4;
  ...
  var ComparableAttrsScope_init_$Create$ = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.h3;
  ...
  var substringAfter = kotlin_kotlin.$_$.xc;
  var substringBefore = kotlin_kotlin.$_$.yc;
  var substringAfterLast = kotlin_kotlin.$_$.vc;
  var removePrefix = kotlin_kotlin.$_$.lc;
  var kebabCaseToTitleCamelCase = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.y2;
  ...
  var substringAfterLast_0 = kotlin_kotlin.$_$.uc;
  ...
  var invokeLater = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.x2;
  var asList = kotlin_kotlin.$_$.cf;
  var Map = kotlin_kotlin.$_$.d5;
  var isInterface = kotlin_kotlin.$_$.na;
  var LinkedHashSet_init_$Create$ = kotlin_kotlin.$_$.u;
  var trimIndent = kotlin_kotlin.$_$.ed;
  ...
  var throwKotlinNothingValueException = kotlin_kotlin.$_$.ye;
  ...
  function toAnimation$composable(_this__u8e3s4, duration, timingFunction, delay, iterationCount, direction, fillMode, playState, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0.startReplaceableGroup_ip860b_k$(-1221404743);
    if (!(($default & 1) === 0))
      duration_0 = null;
    if (!(($default & 2) === 0))
    ...
    var colorMode = _this__u8e3s4.get_usesColorMode_a99qlr_k$() ? Companion_getInstance_10().$get_current$$composable_nxoy3y_k$($composer_0, 6) : null;
  ...
  function toAttrs$composable(_this__u8e3s4, variant, finalHandler, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0.startReplaceableGroup_ip860b_k$(2120490469);
    if (!(($default & 1) === 0))
      variant_0 = null;
    if (!(($default & 2) === 0))
      finalHandler_0 = null;
  ...
  function deferRender$composable(content, $composer, $changed) {
    _init_properties_Deferred_kt__im2yn();
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(360010929);
    var $dirty = $changed;
    if (($changed & 14) === 0)
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(content) ? 4 : 2);
    if (!(($dirty & 11) === 2) ? true : !$composer_0.get_skipping_3owdve_k$()) {
      ...
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = $composer_2.changed_ga7h3f_k$(state);
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
      ...
      deferredEntry.$set_content$$composable_57tyzo_k$(content);
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(deferRender$composable$lambda_0(content, $changed));
    }
  }
  ...
  function registerStyleBase$composable(_this__u8e3s4, cssSelector, extraModifiers, init) {
    _this__u8e3s4.registerStyle$composable_gfqtrt_k$(cssSelector, extraModifiers, registerStyleBase$composable$lambda(init));
  }
  ...
  function registerStyleBase$composable$lambda($init) {
    return function ($this$registerStyle) {
      $this$registerStyle.base_y8uu8g_k$(registerStyleBase$composable$lambda$lambda($init));
      return Unit_getInstance();
    };
  }
  ...
  _.$_$.m1 = suffixedWith;
  _.$_$.n1 = clip;
  _.$_$.o1 = modifyComponentStyleBase;
  _.$_$.p1 = prepareSilkFoundation$composable;
  ...
  _.$_$.v1 = ColorMode_DARK_getInstance;
  _.$_$.w1 = ColorMode_LIGHT_getInstance;
  _.$_$.x1 = RectF_init_$Create$_2;
  _.$_$.y1 = Companion_getInstance_5;
  _.$_$.z1 = Companion_getInstance_10;
  _.$_$.a2 = ColorSchemes_getInstance;
  //endregion
  return _;
}));
